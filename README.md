...
- 여러 개의 `시작 마디 / 끝 마디 / 시작 BPM / 끝 BPM` 구간
- 마디당 또는 박자당 근사
...
3. 근사 간격과 평균 방식을 선택합니다.
4. 충돌 검사와 누적 오차를 확인합니다.
5. **변환 파일 저장**을 누르면 원본 옆에 `_linear_bpm.bms` 파일이 만들어집니다.

`samples\demo_3_4.bms`는 041~048마디가 3/4박으로 설정된 기능 확인용 파일입니다. 기본 입력값 `041 → 049, 120 → 180`을 그대로 시험할 수 있습니다.
